...
document.addEventListener('DOMContentLoaded', () => {
    // Ambil semua tombol dan menu
    const menuButtons = document.querySelectorAll('.menu-group > .mdc-button');

    menuButtons.forEach(button => {
        button.addEventListener('click', () => {
            // Ambil daftar menu yang terkait dengan tombol yang diklik
            ...
            if (menuList.style.display === 'block') {
                ...
                document.querySelectorAll('.menu-group > .mdc-list').forEach(menu => {
